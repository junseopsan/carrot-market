...
const Home: NextPage = () => {
  return (
    <div className="grid min-h-screen gap-10 px-20 py-20 bg-slate-400 xl:place-content-center lg:grid-cols-2 xl:grid-cols-3">
      <div className="flex flex-col justify-between p-6 bg-white shadow-xl rounded-3xl">
        ...
        <button
          className="block w-3/4 p-3 mx-auto mt-5 text-center text-white bg-blue-500 rounded-xl hover:bg-teal-500 hover:text-black active:bg-yellow-500 focus:bg-red-500 "
        >
          Checkout
        </button>
      </div>
      <div className="overflow-hidden bg-white shadow-xl rounded-3xl group">
        <div className="p-6 portrait:bg-indigo-600 landscape:bg-teal-500 pb-14 xl:pb-40">
      ...
      <div className="p-6 bg-white shadow-xl rounded-3xl lg:col-span-2 xl:col-span-1">
